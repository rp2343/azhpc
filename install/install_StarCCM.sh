...
axel -n 50 http://azbenchmarkstorage.blob.core.windows.net/cdadapcobenchmarkstorage/STAR-CCM+11.04.012_01_linux-x86_64-r8.tar.gz
tar xz STAR-CCM+11.04.012_01_linux-x86_64-r8.tar.gz
